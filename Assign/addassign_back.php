      ...
      <form name="customerdata" action="" method="POST">
        <div class="optionBox">
          ...
          if (mysqli_num_rows($resultGuestUpdate) > 0) {
            ...
            $sqlKidCount = "SELECT * FROM guest
                 where order_id='$orderno' and type='kid'";
                            ...
                            <div class='row'>
                              ...
                              <div class='col-md-6 ". $custom_class."'>
                                <div class='form-group'>
                                  ...
                                  <select id='selectPark" . $e . "' name='ticket[]' class='change form-control' ". $disabled." onchange='sel_park(" . $e . ")'>
                              ...
                              if($tpp_id==1){
                                  if ((int) $level > 1) {
                                        echo   "<div class='d-flex flex-wrap w-100 justify-content-start justify-content-md-end'>
                                              <a href='../Orders/admin_text_history.php?id=" . $GuestsUpdate['id'] . "' class='btn btn-primary mr-2 mb-1' role='button' >Text Usage to Admin</a>
                      ...
                      echo "<div class='block'>
                                  <div class='row'>
                                    ...
                                    <div class='col-md-6 ". $custom_class."'>
                                      <div class='form-group'>
                                        <label style='display: block;'>Ticket *</label>
                                        <select id='selectPark" . $sCount . "' ". $disabled,$required ." name='ticket[]' class='change form-control' required onchange='sel_park(" . $sCount . ")'><option value=''>Please Select Ticket 2 </option>";

                      //$sqlGetTicket = "SELECT * FROM ticket";
                      //$sqlGetTicket = "SELECT * FROM ticket where type<>'child'";
                      $sqlGetTicket = $sql_ticket . "and type<>'child' and type<>'youth'";
                      $resultGetTicket = mysqli_query($db, $sqlGetTicket);
                      ...
                      echo "<div class='block'>
                                  <div class='row'>
                                    ...
                                    <div class='col-md-6 ". $custom_class."'>
                                      <div class='form-group'>
                                        <label style='display: block;'>Ticket *</label>
                                        <select id='selectPark" . $sCount . "'  name='ticket[]' class='change form-control' ". $disabled,$required ." onchange='sel_park(" . $sCount . ")'><option value=''>Please Select Ticket 4 </option>";
              ...
              <div class='row'>
                ...
                <div class='col-md-6 <?php echo $custom_class?>'>
                  <div class='form-group'>
                    ...
                    <select id='selectPark1' name='ticket[]' class='change form-control' <?php echo $disabled ?> >
                      <option value=''>Please Select Ticket 5 </option>
                ...
                echo "<div class='block'>
                              <div class='row'>
                                ...
                                <div class='col-md-6 ". $custom_class."'>
                                  <div class='form-group'>
                                    <label style='display: block;'>Ticket *</label>
                                    <select id='selectPark" . $a . "' name='ticket[]' class='change form-control'  ". $disabled ." 
                                    onchange='sel_park(" . $a . ")'><option value=''>Please Select Ticket 6 </option>";
                ...
                echo "<div class='block'>
                              <div class='row'>
                                ...
                                <div class='col-md-6 ". $custom_class."'>
                                  <div class='form-group'>
                                    <label style='display: block;'>Ticket *</label>
                                    <select id='selectPark" . $a . "' name='ticket[]' class='change form-control' ". $disabled ." onchange='sel_park(" . $a . ")'><option value=''>Please Select Ticket 7 </option>";

                //$sqlGetTicket = "SELECT * FROM ticket";
                //$sqlGetTicket = "SELECT * FROM ticket where type<>'adult' and type<>'youth'";
                $sqlGetTicket = $sql_ticket . "and type<>'adult'";
                $resultGetTicket = mysqli_query($db, $sqlGetTicket);
...
<script>
  ...
  function sel_park(id) {
    var ticket_name = $("#selectPark" + id).val();
    var url = "../Ajax/GetTicketById.php?id=" + ticket_name;
    ...
    $.ajax({
      ...
      success: function(res) {
        ...
        $(".typeahead" + id).val(data['name_on_ticket']);
