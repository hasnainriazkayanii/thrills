...
$datas =mysqli_fetch_all($result, MYSQLI_ASSOC);
    ...
    <select class="form-control" name="purpose_type">
        ...
        <option <?php if ($user['purpose_type'] == $data['purpose']) {
                          echo "selected";
                        } ?> value="<?php echo $data['purpose']?>"><?php echo $data['purpose']?> </option>
        ...
        <?php 
          ...
          <input type="text" class="form-control" required name="event" id="city" aria-describedby="event" placeholder="Event *" value='<?= $user['event'] ?>'>
