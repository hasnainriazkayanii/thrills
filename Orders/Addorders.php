    ...
    <script>
      ...
      //          $('#sales_person').val(sales_person);
        ...
        function change_theme_park() {
            ...
            var selectedTicketTypes = ticketTypes.filter(ticket_type => ticket_type.theme_park_id == theme_park_id && ticket_type.add_on == '0');
            ...
            console.log(add_on_type + " console");
        ...
        function total_value() {
            ...
            if (num1 && num2 && num3) {
                ...
                if(addOnPrice){
                    ...
                    totalPrice = parseInt(addOnPricee) + totalPrice;
