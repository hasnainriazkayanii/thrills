                            ...
                            <tr>
                                <td>
                                    ...
                                    <select class="manager_type" style="width: 152:px;">
                                        ...
                                        <option>Venmo</option>
                                        <option>Cash</option>
                                        <option>Cus-Zelle</option>
                                        <option>Cus-CashApp</option>
                                    </select>
...
//                                        }
                                    ...
                                    if($_SESSION['level'] == 9 && $value['status'] == 8 && $buttons == ""){
                                        $buttons = ' <div class="mt-3 text-center">
                                                        <a href="../Assign/Addassign.php?id='.$value["order_id"].'" class="btn btn-info btn-sm" role="button"> Assign Ticket</a>
                                                        ';
                                    }
                                    else if ($_SESSION['level'] == 9 && $value['status'] == 3){
                                        $buttons = '<div class="mt-3 text-center">
                                                        <a href="../Assign/Addassign.php?id=' . $value["order_id"] . '" class="btn btn-warning btn-sm px-3" role="button"> Ticket Info</a>';
                                        $buttons .= '<div class="mt-3 text-center">
                                                        <a href="../History/AddHistory.php?order_id=' . $value["order_id"] . '" class="btn btn-info btn-sm px-3" role="button"> Update Usage</a>';
                                    }
